...
# CSVファイルの読み込み
csv_file = r'\\ivdata01\vol01\3PJ_HIRAMOTO_25TB\市場データ_取り扱い注意\MDC\PB作動点_CAN\2024-08-23T11_15_59.csv'  # CSVファイルのパスを指定してください
output_path = r'\\ivdata01\vol01\3PJ_HIRAMOTO_25TB\市場データ_取り扱い注意\MDC\PB作動点_CAN'  # 出力CSVファイルのパスを指定してください
